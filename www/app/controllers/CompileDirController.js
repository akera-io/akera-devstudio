angular.module('AkeraDevStudio').controller(
    ...
    [
        ...
        '$mdToast',
        'FileUtil',
        function($scope, $mdDialog, apiUtil, $mdToast, fileUtil) {
          ...
          $scope.compileFolder = function() {
            apiUtil.compileDir($scope.selectedNode, $scope.recursiveCompile,
                $scope.compileDir).then(
                function() {
                  $mdToast
                      .show($mdToast.simple().content('Compile successful'));
